...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, KC_LALT, MO(_LOWER), KC_SPC, KC_RCTL, KC_RSFT, KC_RGUI, _______, _______    , _______
),

[_LOWER] = LAYOUT_planck_grid(
    KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS,
    _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_EQL ,
    _______, KC_TILD, _______, _______, _______, _______, _______, _______, _______, UK_PND , KC_QUOT, KC_BSLS,
